...
@Path("/resource")
public class SampleJavaAdapterResource {
	/*
	...
	static Logger logger = Logger.getLogger(SampleJavaAdapterResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleJavaAdapter/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleJavaAdapter/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleJavaAdapter/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleJavaAdapter/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleJavaAdapter/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/SampleJavaAdapter/resource/protected"
	 */
